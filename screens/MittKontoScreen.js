...
export default class MittKontoScreen extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      url: (this.props.screenProps !== '' && !global.registered) ? (Platform.OS==='ios'?this.props.screenProps.replace('https','https:'):this.props.screenProps) : 'https://www.care24.se/account',
      loaded: false,
      loggedInState: false,
      canGoBack: false,
  ...
  _showProfilePage = () => {
    ...
    Linking.openURL('https://care24.se/account/profile'); 
  };
  ...
  _onNavigationStateChange = (webViewState) => { // you can also use navState
    ...
    let loggedIn = webViewState.url.search('https://www.care24.se/account') > -1;
    let profile = webViewState.url.search('https://www.care24.se/account/profile') > -1;
    ...
    // borderRadius: 50,
        ...
        {/* this.state.canGoBack &&
          ...
          >
            ...
            <Text style={{ fontSize: 16, marginLeft: 5 }}>Tillbaka</Text>
          </TouchableOpacity>
        */ }
