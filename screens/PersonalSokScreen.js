...
static navigationOptions = ({navigation}) => {
  return {
    ...
    headerRight: (
    <TouchableOpacity  style={{marginRight: 15, flex: 1, justifyContent: 'center', alignItems:'center'}} onPress={ () => navigation.navigate('Personel')}>
      ...
      <View style={ { flex: 1 } }>
        ...
        />
         <WebView
                 ...
                 source={ { uri: 'https://www.care24.se/m-personal' } }
